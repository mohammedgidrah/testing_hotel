...
export default function Orders() {
  ...
  const handleFormChange = (e) => {
   ...
   if (name === "item_id") {
      ...
      // Update form data with item's price and calculate total
      ...
      setFormData((prev) => ({
        ...
        total_price: (selectedItem?.price || 0) * quantity
      }));
      ...
      setFormData(prev => ({
        ...prev,
        [name]: newQuantity,
        total_price: (selectedItem?.price || 0) * newQuantity
      }));
    } else {
  ...
  const validateForm = () => {
    ...
    const priceValue = parseFloat(formData.price_per_item);
    if (isNaN(priceValue) || priceValue < 0) {
      errors.price_per_item = t("priceRequired") || "Valid price is required";
    }
