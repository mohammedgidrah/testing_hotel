        ...
        <div className="container mx-auto p-6">
            ...
            <div className="flex flex-wrap">
                {users.map((user) => (
                    ...
                    >
                        <div className='p-4 h-32' style={{ direction: '' }} >
                            <h2 className='text-lg font-medium text-gray-100'>{t("UserInformation")}</h2>
                            <p className='text-sm text-gray-400'>{t("Name")}: {user.name}</p>
                            <p className='text-sm text-gray-400'>{t("Email")}: {user.email}</p>
                            <p className='text-sm text-gray-400'>{t("Role")}: {user.role}</p>
                        </div>
